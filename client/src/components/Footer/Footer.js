    ...
    return (
        <footer>
          <div className="footer fixed-bottom bg-dark text-white text-center d-flex justify-content-around">
            ...
            <button onClick={() => window.location='/scan'}type="button" class="btn btn-outline-light p-1 mx-1 mb-2 mt-2"><i class="fas fa-qrcode mx-2"></i>Scan</button>
            ...
            <button onClick={() => window.location='/pay'}type="button" class="btn btn-outline-secondary p-1 mx-1 mb-2 mt-2"><i class="fas fa-dollar-sign mx-2"></i>Pay</button>
            <button onClick={() => window.location='/chart'}type="button" class="btn btn-outline-warning p-1 mx-1 mb-2 mt-2"><i class="fas fa-parking mx-2"></i>Chart</button>
